package com.enterprise.erp.shared.application.constants;
...
public enum ApiErrorCode {
    ...
    SALES_ORDER_INVALID_CANCEL("ERP-SALE-003", "La orden de venta no puede cancelarse en su estado actual"),
    SALES_ORDER_WAREHOUSE_REQUIRED("ERP-SALE-004", "La orden de venta no tiene un almacén asociado"),
    ...
    PURCHASE_ORDER_INVALID_UPDATE("ERP-PUR-003", "Solo se puede actualizar una orden en borrador"),
    PURCHASE_ORDER_INVALID_CANCEL("ERP-PUR-004", "Solo se puede cancelar una orden en borrador"),
